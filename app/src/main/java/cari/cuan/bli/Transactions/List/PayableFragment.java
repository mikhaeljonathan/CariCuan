...
import cari.cuan.bli.Transactions.Transaction;
...
public class PayableFragment extends Fragment {
    ...
    private Query mDatabasePayable;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mDatabasePayable = FirebaseDatabase.getInstance().getReference().child("Transactions")
                .orderByChild("buyer").equalTo(mAuth.getCurrentUser().getUid());
    ...
    public void onStart() {
        ...
        options = new FirebaseRecyclerOptions.Builder<Transaction>()
                .setQuery(mDatabasePayable, Transaction.class).build();
